...
`2.411 GiB`, on four Apple Accelerate threads. See the [#1061 record](docs/r4_zoology_exact_coherent_inference_1061.md).
...
24 of 120 H4 frames. [#1059](docs/r4_zoology_coherent_inference_1059.md) remains a predecessor positive:
