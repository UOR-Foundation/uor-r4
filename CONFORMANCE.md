...
| ID | Level | Execution scope | Serving reachability | Evidence | Statement |
| --- | --- | --- | --- | --- | --- |
| `RF-31` | `build` | `normative-runtime` | `deployed-serving` | features/suites/skipmix_serving_lane.feature; crates/uor-r4-graph-format/src/skipmix.rs; crates/uor-r4-graph-runtime/src/engine.rs; crates/uor-r4-api/src/deployed_quality.rs; crates/uor-r4-api/src/production_envelope.rs; src/cross_surface_parity.rs; docs/adr/0001-normative-r4g1-scorer.md; docs/skipmix_endtoend_causal_908.md; docs/normative_r4g1_quality_933.md | NOT ESTABLISHED empirical quality at deployed-serving scope: bounded SKMX/PSIB compiler emission and fixed-capacity candidate contribution are reachable through the normative R4G1Runtime and schema-2 production surfaces, but #933's CID-bound serving census must still ratify, limit, or retire RF-31 |
