...
- **Planning adoption (2026-09-03):** [adopted issues](integration/adopted-issues.json)
  ...
  [#1086 native-reference specification](r4_native_reference_1086.md) now records
  `NATIVE_REFERENCE_CONTRACT_SPECIFIED`, based on the
  ...
  its native implementation/export/comparison successor, using the frozen contract
  and named admission checks; native execution
  remains `NOT_RUN`. #1094 is closed through protected PR #1101 and its consumed
  comparison envelope is not rerun; #973 stays open and #954 blocked.
