...
- **Related:** terminology for existing graph-compiler concepts lives in
  ...
  [`R4LearnedAssociativeReadoutPromptCapacityV1`](r4_learned_associative_readout_prompt_capacity_973.md).
