...
**Sequencing update after the owner's bridge review:** the [cross-mechanism synthesis](geometric-attention-mechanism-synthesis-2026-09-20.md) connects this note to current and retired implementations. PR #1314 is executed and audited. The [next contextual geometric reader](deepseek-relational-reader-step-2026-09-20.md) actively tests learned directed H4 relations, the reduced quaternionic Hopf/spin bridge, against a calibrated copy comparator. General S7/E8 or harmonic state and persistent role banks remain conditional on the distinction or retention need they address. Dated running-state and scheduling statements below are historical; the [canonical plan](project-track.md#structural-memory-and-geometric-representation-follow-up) owns current sequencing.
