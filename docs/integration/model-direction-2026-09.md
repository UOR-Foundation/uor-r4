...
**Current synthesis:** the [review after PR #1304](prefix-pilot-review-2026-09-20.md) retains the prefix pilot's failed hard-forward screen while correcting incomplete artifact/reload, generation and statistical-preservation claims. The [next complete prompt](deepseek-readout-diagnostic-step-2026-09-20.md) recovers those saved candidates without fitting them again, then runs one fixed-feature empirical-versus-smoothed output-head diagnostic. Count matching is not a prerequisite for further state research. The rejected prefix residual is separable from the local query; local-conditioned geometric read/update, selective forgetting and exact memory remain larger architectural obligations. The diagnostic is NOT_RUN. D0-b and geometric priority remain; no useful-language or 2I-superiority claim follows. The [takeover review](takeover-review-2026-09-19.md) preserves the broader history/source map.
