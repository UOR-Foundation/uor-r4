...
**Next mechanism:** learn contextual memory utility over frozen E plus S-query-only, allowing ranking, NoRead and bounded copy strength to change with a minimal causal contextual feature where justified. [Comprehensive handoff](deepseek-memory-utility-step-2026-09-20.md). This supersedes the frozen-ranker/one-abstention-signal prescription.
