...
| 1 — native joint learning | Train one recurrent-memory student with continuous read/representation/state/output credit on the same natural data, plus a competitive ordinary recurrent control. An offline #1017 teacher is optional and declared. Use real autodiff and inspect nonzero gradients, retained fit, learning curves, natural likelihood and complete generation. | Active: [corrected paired campaign](joint-recurrent-campaign-2026-09-24.md#corrected-continuation-full256-token-language-credit); retain matched 8,617,984-visit warmup and align further training/evaluation at 256 tokens. Measured CPU sequence parallelism is selected; continue toward 29,999,104 total visits per arm with preserved checkpoints and resource stops. Results and artifacts belong in current state. |
