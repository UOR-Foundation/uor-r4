...
| 2 — discretize the working student | Add declared straight-through/annealed quantization, commitment/usage terms where needed, matched codebooks and explicit gains. Train and score both relaxed and exported hard paths throughout; preserve language behavior and measure the gap. | In progress: [frozen quantized continuation](quantized-recurrent-plan-2026-09-25.md), [execution receipt](../evidence/quantized-recurrent-execution-freeze-2026-09-25.json), PR #1390. Packed parents reload with exact measured hard outputs; paired QAT and continuous continuations target common step 8,348. Final retention is pending; packed F32 emulation is not integer serving. |
