...
| 2 — discretize the working student | Add declared straight-through/annealed quantization, commitment/usage terms where needed, matched codebooks and explicit gains. Train and score both relaxed and exported hard paths throughout; preserve language behavior and measure the gap. | Open retention gate: [first recipe completed and rejected](quantized-recurrent-result-2026-09-25.md), PR #1390. Final packed minus matched continuous NLL is +0.059113/+0.079827 against +0.05; ordinary also short-cycles. All four reach fixed step 8,348. Next: one projected-shadow continuation from full-hard midpoint 7,836 with unchanged scales/data/gates; NOT_RUN. Packed F32 emulation does not qualify integer serving. |
