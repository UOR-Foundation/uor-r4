...
**Current sequencing after PR #1328:** the [principal review](reader-utility-review-2026-09-21.md) retains the small held-out text-loss gain but finds a train/serve gap-index mismatch. [Complete the correctly indexed policy experiment](deepseek-reader-policy-contract-step-2026-09-21.md) before attributing its emission collapse to missing contextual state. Signed H4/Spin, scalar utility, exact occurrence identity, learned structural lifetime, dependent composition and conditional retained Hopf fiber/S7/E8/harmonic mechanisms retain their roles. PaTH/GRAPE motivate future finite content-dependent transport, not dense serving or an automatic representation expansion. Earlier execution pointers below are historical.
