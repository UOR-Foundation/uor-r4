...
**Current sequencing after PR #1330:** the [principal review](policy-objective-review-2026-09-21.md) verifies the feature repair and negative text/answer/absence outcome. [Settle finite-policy feasibility once](deepseek-policy-feasibility-step-2026-09-21.md) before interpreting a dimensional limitation. Use explicit joint constraints and collect missing alternative-action statistics. A failed/unresolved result ends this scalar-policy campaign. Select omitted causal confidence, learned structural persistence, admission repair or a shared derived-output operator from evidence; timeout alone is not a mechanism defect. Signed H4/Spin, exact occurrence identity, scalar utility and conditional retained Hopf fiber/S7/E8/harmonic mechanisms remain on the roadmap. Earlier execution pointers below are historical.
