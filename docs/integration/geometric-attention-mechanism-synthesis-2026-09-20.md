...
September 20, 2026; source basis `fbf542aa4c1f7ed336cd028c6b7b3502cba4118c`. This is a source/literature synthesis, not a new model result. The [canonical plan](project-track.md#structural-memory-and-geometric-representation-follow-up) owns sequencing; [current state](current-state.md) owns measured outcomes. The [correcting occurrence-reader audit](occurrence-reader-audit-2026-09-20.md) corrects the evidence for the immediate successor. The owner subsequently reconfirmed that the mathematical bridges should guide that successor, not merely be parked behind calibration. **The selected primary experiment is learned contextual query/source descriptions and directed H4 reads**, with a repaired/calibrated copy reader as comparator and loss-based integration in both arms. [Single execution prompt](deepseek-relational-reader-step-2026-09-20.md).
