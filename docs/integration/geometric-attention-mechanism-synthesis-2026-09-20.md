...
**September22 principal update:** [PR1344 review](structured-argument-binding-review-2026-09-22.md) retains the any-order semi-Markov draft and repairs identity/learning/restore seams. Complete ordinary argument binding before broader scopes or prose. Ordered120-element binary-icosahedral interval potentials remain a concrete geometric candidate; categorical interior bags need order-aware controls. Learned scalar span/role potentials provide a finite function-space connection to harmonic ideas, whose alternative parameterization requires measured benefit. Higher geometry does not repair missing candidates or inconsistent inputs. [Completion brief](deepseek-structured-binding-completion-step-2026-09-22.md).
