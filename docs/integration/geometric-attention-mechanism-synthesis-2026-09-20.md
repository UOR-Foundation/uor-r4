...
**Current sequencing after PR #1325/#1326:** the [principal review](relational-learning-review-2026-09-21.md) retains stronger learned signed relations and corrects admission/freshness claims. [Direct language read utility](deepseek-reader-utility-transfer-step-2026-09-21.md) is next, using causal local-score observations and actual finite-action costs. This puts scalar utility beside active signed H4/Spin relations; structural persistence, dependent composition and conditional Hopf/S7/E8/harmonic state retain their capability roles. New PaTH/GRAPE connections in the review concern future content-dependent transport, not adoption of matrix serving. Earlier execution pointers below are historical.
