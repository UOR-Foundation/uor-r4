...
**Update after executed PR #1319:** the [review](relational-reader-review-2026-09-20.md) retains a learned finite-reader construction gain but identifies invalid categorical attribution, a source-class shortcut and incomplete runtime controls. The [active successor](deepseek-competitive-reader-step-2026-09-20.md) learns competitive query-dependent access through a shared causal inference path. The reduced H4/Hopf/spin bridge remains active; no higher-dimensional advantage has been inferred. Dated execution pointers below describe the earlier design.
