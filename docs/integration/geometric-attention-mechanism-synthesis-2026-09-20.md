...
**Current sequencing after PR #1323:** the [principal review](contextual-utility-review-2026-09-21.md) retains contextual utility and derives a signed antipodal capacity witness for the present relation task. [Learn that relation](deepseek-relational-learning-step-2026-09-21.md) under matched optimization and document holdout next. This actively connects spin/H4 structure to a falsifiable learner; static token codes are not contextual syntactic roles. Role/scope persistence and conditional Hopf/S7/E8/harmonic state remain in the five-stage roadmap. Earlier execution pointers below are historical.
