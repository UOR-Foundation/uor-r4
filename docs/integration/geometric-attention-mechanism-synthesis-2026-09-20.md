...
**Current sequencing after PR #1321:** [principal synthesis and source corrections](competitive-reader-review-2026-09-20.md) preserve useful aggregate construction evidence but not unique-H4 attribution. [Contextual read utility with natural-text fitting](deepseek-contextual-utility-step-2026-09-20.md) is next. Directed H4 relations and scalar influence are complementary; role/scope persistence, retained fiber, S7/E8 and harmonic coefficients enter for the limit they address. Earlier execution pointers below are historical.
