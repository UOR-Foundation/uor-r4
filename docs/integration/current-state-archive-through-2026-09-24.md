> Historical archive preserved September 24, 2026. The [current state](current-state.md) and [canonical plan](project-track.md) own live authority; dated next actions below retain historical scope only.
