...
**Latest specification (2026-09-03):** [#1085](integration/clause-segmentation-1085.md)
...
[current map](integration/current-state.md).
...
> are parked. Provider-free-at-execution, source-backed native CPU
...
> explicit opt-in, loopback-only dedicated native HTTP endpoint then passed the
...
> without rerun, further 7.15M exposure, or learning-rate tuning. That one
