...
ap.add_argument('--root',default='scoped-memory-principal-3')
ap.add_argument('--output',default='/tmp/uor-scoped-corrected-independent-audit.json')
...
out={'schema':'uor-r4.scoped-corrected-independent-audit/1','root':str(root),'method':'Read-only audit of report, raw authored assertions/questions, learned artifacts and source/executable bytes; no model execution','seals':[]}
...
exe=base/'scoped-memory-principal-delivery/competitive-reader-38bf325f'
