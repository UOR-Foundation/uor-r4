...
| **Corpus Pipeline** | [`mmap_corpus.rs`](crates/uor-r4-core/src/native_geometric/mmap_corpus.rs), [`bin/pretokenize_corpus.rs`](crates/uor-r4-core/src/bin/pretokenize_corpus.rs) | Streaming binary `u16` token corpus reader/writer with zero heap allocations. |
| **Learner & JEPA Trainer** | [`learner/jepa_trainer.rs`](crates/uor-r4-core/src/native_geometric/learner/jepa_trainer.rs), [`bin/train_native_prose.rs`](crates/uor-r4-core/src/bin/train_native_prose.rs) | Dual-objective $L_{\text{CE}} + \lambda L_{\text{JEPA}}$ training; Rayon parallel batches; Adam optimizer. |
