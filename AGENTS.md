...
task is [#1094](https://github.com/UOR-Foundation/uor-r4/issues/1094): separately
activate the frozen `run-retained` comparison/replay with the accepted exact
release, using the [implemented handoff](docs/r4_retained_assembly_1094.md).
Preserve the bound coordinator, unchanged worker/reader/core, 120-second historical
debit and 3,465,401 historical bytes. No new preparation invocation is admitted.
