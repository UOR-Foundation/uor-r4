...
task after #1094's protected delivery is
[#1086](https://github.com/UOR-Foundation/uor-r4/issues/1086): freeze the exact
native export/loader/reference-behavior contract using the
[bounded raw-text comparison evidence](docs/r4_retained_comparison_1094.md).
Specify the smallest matched native/reference check and resource envelope before
implementation. Do not rerun the consumed #1094 envelope or widen its scope.
