...
export const typed_r4g1_response: (a: number, b: number, c: number) => [number, number];
...
export const uorr4router_get_brain_state_wasm: (a: number, b: number, c: number) => [number, number];
