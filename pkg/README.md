...
The accumulated memory repair is parked with all source, artifacts and evidence preserved. Its bounded historical results remain in their issue records. The retained model is `15baec48`; exact addressed memory and typed operators remain part of the architecture, but are not yet connected to the new core experiment. Intermediate-version repair is no longer the active next step.
