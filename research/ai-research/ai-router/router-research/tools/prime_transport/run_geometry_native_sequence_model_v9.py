#!/usr/bin/env python3
"""Run the bounded multi-chart selection comparison."""
...
from geometry_native_sequence_model_v9 import run_bounded_sequence_comparison_v9


ROOT = Path(__file__).resolve().parents[2]
RESULTS_DIR = ROOT / "results" / "prime_transport_recursive_system"
OUTPUT_CSV = RESULTS_DIR / "prime_transport_geometry_native_sequence_model_v9.csv"


def main() -> None:
    RESULTS_DIR.mkdir(parents=True, exist_ok=True)
    metrics = run_bounded_sequence_comparison_v9(TaskConfigV7(), seed=101)
