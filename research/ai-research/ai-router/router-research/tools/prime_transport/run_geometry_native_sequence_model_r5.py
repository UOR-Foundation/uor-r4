#!/usr/bin/env python3
"""Runner for the fifth inner-representation rebuild."""
...
from geometry_native_sequence_model_r5 import TaskConfigR5, run_bounded_sequence_comparison_r5
...
def main() -> None:
    metrics = run_bounded_sequence_comparison_r5(TaskConfigR5(), seed=241)
