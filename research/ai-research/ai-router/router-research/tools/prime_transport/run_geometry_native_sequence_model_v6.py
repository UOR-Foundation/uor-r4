#!/usr/bin/env python3
"""Run the cross-family transfer comparison for the geometry-native engine."""
...
from geometry_native_sequence_model_v6 import TaskConfigV6, run_bounded_sequence_comparison_v6


ROOT = Path(__file__).resolve().parents[2]
RESULTS_DIR = ROOT / "results" / "prime_transport_recursive_system"
OUTPUT_CSV = RESULTS_DIR / "prime_transport_geometry_native_sequence_model_v6.csv"


def main() -> None:
    RESULTS_DIR.mkdir(parents=True, exist_ok=True)
    metrics = run_bounded_sequence_comparison_v6(TaskConfigV6(), seed=79)
