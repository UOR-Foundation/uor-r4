#!/usr/bin/env python3
"""INC-0171: End-to-End Language Model Integration of Hopf Angular Routing.

Tests whether the canonical Hopf routing mechanism (INC-0169 TRANS ORIG)
survives transfer from the PPMI-SVD proxy to a real trainable language model,
specifically as a replacement for the learned FFN gating layer in a small
transformer.
...
def main():
    ...
    ap.add_argument("--output", type=str,
                    default=os.path.join(OUTPUT_DIR, "inc0171_lm_integration.json"))
    args = ap.parse_args()
    ...
    print("=" * 72)
    print("INC-0171: END-TO-END LM INTEGRATION — HOPF vs BASELINE vs PERMUTED")
    print("=" * 72)
