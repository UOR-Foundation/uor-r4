# Dual-Anchor Real-Task Downstream Carry-Forward

## Summary
- Contract: `dual_anchor_downstream_real_task_default_comparison`
- Surface: `lm_proxy_real_task_downstream`
- Read: The explicit downstream LM-proxy real-task comparison now carries forward CHART_H4XH4_FIELD_A150_EVT_T070_BF2_SB1_CPX8_Q01_T2500 as the lower-bank systems-only default and CHART_H4XH4_FIELD_A150_EVT_T070_CPX8_Q01_T40000 as the promoted upper-bank downstream default. CHART_H4XH4_FIELD_A150_EVT_T070_BF2_SB1_CPX8_Q01_T40000 remains available only when a downstream real-task branch explicitly needs a pruning or systems comparator.
