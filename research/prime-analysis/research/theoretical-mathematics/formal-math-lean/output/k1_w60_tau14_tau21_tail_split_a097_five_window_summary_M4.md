...
- Base threshold: `a1=0.97`
- Robust mode counts (`delta_split_min>0` across all windows): 4
- Robust mode counts (`delta_split_neg_min>0` across all windows): 4

| M | d_split_min | d_split_neg_min | d_raw_neg_min | q_split_max | q_split_neg_max | q_raw_neg_max | robust_abs | robust_neg |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 4 | 0.159385 | 0.539699 | 0.895328 | 0.810615 | 0.430301 | 0.074672 | true | true |
