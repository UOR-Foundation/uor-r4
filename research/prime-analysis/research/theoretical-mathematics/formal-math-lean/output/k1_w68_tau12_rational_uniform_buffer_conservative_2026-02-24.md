...
- `rho_interval = [1.478494608041662, 1.496091647267163]`
- `q_scan_max = 1000`

## Small-Denominator Scan
- first denominator with any `p/q` in interval: `25`
- certified denominator lower bound from scan: `q >= 25`

## Key C2 Certificate
- `q=2` excluded by interval: `True`
- distance from interval to `3/2`: `0.003908352733`
- uniform rational-branch buffer from denominator bound: `c0_uniform = cos(pi/25) = 0.992114701314`
