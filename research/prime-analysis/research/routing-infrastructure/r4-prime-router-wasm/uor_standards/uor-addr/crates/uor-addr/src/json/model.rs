...
//! the shared [`AddressResolverTuple`](crate::resolvers) ψ-tower and the
//! axis's capacity profile ([`AddrBounds`](crate::bounds::AddrBounds) for
//! the 32-byte axes, [`AddrBounds64`](crate::bounds::AddrBounds64) for
//! sha512); the input is the ADR-060 borrowed-carrier handle [`JsonCarrier`].
//! `AddressModel` (sha256) is the default.
