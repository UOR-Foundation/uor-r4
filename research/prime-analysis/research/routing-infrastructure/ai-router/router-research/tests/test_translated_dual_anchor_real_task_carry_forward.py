...
from tools import translated_dual_anchor_real_task_carry_forward as audit


class TranslatedDualAnchorRealTaskCarryForwardTest(unittest.TestCase):
    def _comparison(self):
        return {
            "comparison_surface": "lm_proxy_real_task",
            "packet_id": "inc0116_packet",
            "packet_mode": "dual_anchor_default_packet",
            "default_real_task_route_ids": [
                "DENSE_Q01_T2500",
                "CHART_H4XH4_FIELD_A150_EVT_T070_BF2_SB1_CPX8_Q01_T2500",
                "DENSE_Q01_T40000",
                "CHART_H4XH4_FIELD_A150_EVT_T070_CPX8_Q01_T40000",
            ],
            "optional_real_task_comparator_route_ids": [
            ...
            "optional_upper_real_task_comparator": {
    ...
    def test_build_payload_carries_explicit_real_task_defaults(self):
        payload = audit.build_payload(self._comparison())

        self.assertEqual(
            payload["carry_forward_contract"],
            "dual_anchor_real_task_default_comparison",
        )
        self.assertEqual(
    ...
    def test_build_payload_rejects_unexpected_default_routes(self):
        ...
        comparison["default_real_task_route_ids"] = ["wrong"]
