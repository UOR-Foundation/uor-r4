"""Second independently frozen matched-prompt criterion for issue #973.

This module does two things only:

* deterministically commits a population strictly after the revealed V1 boundary; and
...
language model.  The complete V2 population has its own schemas and storage
namespace, is sealed before candidate fitting, and is opened only after the
qualified V1 and direct-readout candidate artifact CIDs have been fixed.  No
V1 population file is read by this module.
"""
...
PRIOR_DEVELOPMENT_LAST_SOURCE_STORY_ORDINAL = 153_977
PROMPT_TOKENS = 48
...
POPULATION_SCHEMA = "uor-r4.retained-prompt-swap-population/2"
COMMITMENT_SCHEMA = "uor-r4.retained-prompt-swap-commitment/2"
REVEAL_SCHEMA = "uor-r4.retained-prompt-swap-reveal/2"
SCORE_SCHEMA = "uor-r4.retained-prompt-swap-score/2"
DECISION_SCHEMA = "uor-r4.retained-prompt-swap-decision/2"

WORK_RELATIVE_PATH = "prompt-conditioning-v2"
...
SELECTION_CONTRACT = {
    ...
    "source_order": "strictly ascending after revealed V1 boundary 153977",
    "utf8": "strict",
...
def select_prompt_conditioning_population(
    ...
    without materializing the 153,978-story prefix.  Production callers must
