...
from .model import ZoologyJointQueryModel as ZoologyFigure2Model
...
def _existing_result(
    ...
    if (
        ...
        or result["artifact"].get("query_encoding") != QUERY_ENCODING
    ):
...
def _fit_locked(root: Path, preparation: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if start_path.exists():
        ...
        started = release._with_cid(
            {
                "schema": "uor-r4.zoology-joint-query-fit-start/1",
                "binding_cid": binding,
    ...
    def save() -> None:
        ...
        _save_checkpoint(
            checkpoint_path,
            {
                "schema": "uor-r4.zoology-joint-query-fit-checkpoint/1",
                "binding_cid": binding,
    ...
    result = release._with_cid(
        {
            "schema": "uor-r4.zoology-joint-query-fit/1",
            ...
            "artifact": {
                **_record(folder / "model.safetensors", root),
                ...
                "query_encoding": dict(QUERY_ENCODING),
            },
