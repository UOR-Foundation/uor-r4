...
from .model import MODEL_POLICY
from .model import CompoundBindingConfig as ZoologyFigure2Config
from .model import CompoundBindingModel as ZoologyFigure2Model
...
def _existing_result(
    ...
    if (
        ...
        or result["artifact"].get("model_policy") != MODEL_POLICY
    ):
...
def _fit_locked(root: Path, preparation: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if start_path.exists():
        ...
        started = release._with_cid(
            {
                "schema": "uor-r4.zoology-compound-binding-fit-start/1",
                "binding_cid": binding,
    ...
    def save() -> None:
        ...
        _save_checkpoint(
            checkpoint_path,
            {
                "schema": "uor-r4.zoology-compound-binding-fit-checkpoint/1",
                "binding_cid": binding,
    ...
    result = release._with_cid(
        {
            "schema": "uor-r4.zoology-compound-binding-fit/1",
